...
{{< figure src="/ox-hugo/20250207092636-emacs--Ollama-Buddy-Local-LLM-Integration-for-Emacs.jpg" width="100%" >}}
...
{{< figure src="/ox-hugo/ollama-buddy-screen-recording_001.gif" width="100%" >}}

**More conversational**

{{< figure src="/ox-hugo/ollama-buddy-screen-recording_002.gif" width="100%" >}}

**Describing code with different models**

{{< figure src="/ox-hugo/ollama-buddy-screen-recording_003.gif" width="100%" >}}

**Describing code with a more advanced model**

{{< figure src="/ox-hugo/ollama-buddy-screen-recording_004.gif" width="100%" >}}

**The Menu**

{{< figure src="/ox-hugo/ollama-buddy-screenshot_001.png" width="100%" >}}
